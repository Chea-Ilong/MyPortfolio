...
const Skills = () => {
  ...
  return (
    <section id="skills" className="py-12 sm:py-16 md:py-20 min-h-screen flex items-center bg-white dark:bg-[#1F1D1B] transition-colors duration-500 overflow-hidden">
